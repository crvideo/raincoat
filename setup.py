...
setuptools.setup(
    ...
    description="Raincoat-prowlarr is a tool to search torrents using jackett and search torrents and nzb files using prowlarr and send them to your client.",
